...
wp_enqueue_script( 'wcrl_fancybox', WOO_READ_LITTLE_ASSETS_URL . 'js/jquery.fancybox.min.js', array( 'jquery' ), '3.5.7', true );
wp_enqueue_style( 'wcrl_fancybox', WOO_READ_LITTLE_ASSETS_URL . 'css/jquery.fancybox.min.css', array(), '3.5.7' );
